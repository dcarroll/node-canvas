...
Logger = (function() {
  ...
  Logger.prototype.write_status = function(status, options) {
    ...
    opts = coffee.helpers.merge(this.options, options);
  ...
  Logger.prototype.log = function(opts, cb) {
    ...
    options = coffee.helpers.merge(this.options, opts);
    if (options.txn === true) {
  ...
  Logger.prototype.finish = function(opts) {
    ...
    return this.write(coffee.helpers.merge(options, {
      elapsed: "" + elapsed + "ms"
    }));
  };
  ...
  Logger.prototype.failure = function(message, options) {
    ...
    return this.write_status("failure", coffee.helpers.merge(options, {
      message: message
    }));
  };
  ...
  Logger.prototype.error = function(err, opts) {
    ...
    options = coffee.helpers.merge(this.options, options);
  ...
  Logger.prototype.measure = function(name, value, options) {
    ...
    return this.write(coffee.helpers.merge({
      measure: name,
      value: value
    }, options));
  };
